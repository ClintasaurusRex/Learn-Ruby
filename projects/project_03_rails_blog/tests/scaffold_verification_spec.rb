...
RSpec.describe 'rails blog scaffold output' do
  let(:app_root) { File.expand_path('../src/rails_blog_app', __dir__) }

  it 'has expected generated directories after scaffold script runs' do
